...
<div class="tutor-single-course-lead-info">
	...
	<div class="tutor-course-badges-wrap">
		...
		<div class="tutor-course-header-categories" style="color:#ED9700">
			<?php
	...
	<h1 class="tutor-course-header-h1" style="color:#fff"><?php the_title(); ?></h1>
		...
		<?php if ( $instructors ) : ?>
			<?php foreach ( $instructors as $instructor ): ?>
				<div class="lead-meta-item meta-instructor">
					...
					<div
						class="lead-meta-value instructor-name" style="color:#fff"><?php echo esc_html( $instructor->display_name ); ?></div>
				</div>
			<?php endforeach; ?>
		<?php endif; ?>
